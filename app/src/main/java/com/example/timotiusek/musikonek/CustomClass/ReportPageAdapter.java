...
public class ReportPageAdapter extends BaseAdapter{
    ...
    @BindView(R.id.report_title__report_page_rl)
    TextView reportTitle;

    @BindView(R.id.report_date_and_time__report_page_rl)
    TextView reportDateAndTime;


    public ReportPageAdapter(ArrayList<Report> reports, Context mContext){
